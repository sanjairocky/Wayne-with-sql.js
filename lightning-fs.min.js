  ...
  return (function (t) {
    ...
    function (t, e) {
      ...
      t.exports = {
        ...
        resolve: function (...t) {
          let e = "";
          for (let s of t) e = s.startsWith("/") ? s : i(n(e, s));
          return e;
        },
      };
    },
        ...
        _withIDBStore(t, e) {
          return (
            ...
            this._dbp.then(
              (i) =>
                new Promise((n, s) => {
                  const r = i.transaction(this.storeName, t);
                  (r.oncomplete = () => n()),
                    (r.onabort = r.onerror = () => s(r.error)),
                    e(r.objectStore(this.storeName));
                })
            )
          );
        }
    ...
    function (t, e, i) {
      ...
      function r(t, e) {
        ...
        return [(...t) => e(null, ...t), (e = n(e))];
      }
      t.exports = class {
        constructor(...t) {
          (this.promises = new s(...t)),
        ...
        init(t, e) {
          return this.promises.init(t, e);
        }
        readFile(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.readFile(t, e).then(n).catch(s);
        }
        writeFile(t, e, i, n) {
          const [s, o] = r(i, n);
          this.promises.writeFile(t, e, i).then(s).catch(o);
        }
        unlink(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.unlink(t, e).then(n).catch(s);
        }
        readdir(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.readdir(t, e).then(n).catch(s);
        }
        mkdir(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.mkdir(t, e).then(n).catch(s);
        }
        rmdir(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.rmdir(t, e).then(n).catch(s);
        }
        rename(t, e, i) {
          const [n, s] = r(i);
          this.promises.rename(t, e).then(n).catch(s);
        }
        stat(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.stat(t).then(n).catch(s);
        }
        lstat(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.lstat(t).then(n).catch(s);
        }
        readlink(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.readlink(t).then(n).catch(s);
        }
        symlink(t, e, i) {
          const [n, s] = r(i);
          this.promises.symlink(t, e).then(n).catch(s);
        }
        backFile(t, e, i) {
          const [n, s] = r(e, i);
          this.promises.backFile(t, e).then(n).catch(s);
        }
        du(t, e) {
          const [i, n] = r(e);
          this.promises.du(t).then(i).catch(n);
        }
        flush(t) {
          const [e, i] = r(t);
          this.promises.flush().then(e).catch(i);
        }
      };
    },
    function (t, e) {
    ...
    function (t, e, i) {
      ...
      function a(t, e, i, ...n) {
        return (
          (void 0 !== i && "function" != typeof i) || (i = {}),
          "string" == typeof i && (i = { encoding: i }),
          [(t = r.normalize(t)), e, i, ...n]
        );
      }
      function h(t, e, ...i) {
        return [r.normalize(t), r.normalize(e), ...i];
      }
      t.exports = class {
        constructor(t, e = {}) {
          (this.init = this.init.bind(this)),
            (this.readFile = this._wrap(this.readFile, o, !1)),
            (this.writeFile = this._wrap(this.writeFile, a, !0)),
            (this.unlink = this._wrap(this.unlink, o, !0)),
            (this.readdir = this._wrap(this.readdir, o, !1)),
            (this.mkdir = this._wrap(this.mkdir, o, !0)),
            (this.rmdir = this._wrap(this.rmdir, o, !0)),
            (this.rename = this._wrap(this.rename, h, !0)),
            (this.stat = this._wrap(this.stat, o, !1)),
            (this.lstat = this._wrap(this.lstat, o, !1)),
            (this.readlink = this._wrap(this.readlink, o, !1)),
            (this.symlink = this._wrap(this.symlink, h, !0)),
            (this.backFile = this._wrap(this.backFile, o, !0)),
            (this.du = this._wrap(this.du, o, !1)),
        ...
        async _init(t, e = {}) {
          await this._gracefulShutdown(),
            ...
            (this._backend = e.backend || new n()),
            this._backend.init && (await this._backend.init(t, e)),
        ...
        _wrap(t, e, i) {
          return async (...n) => {
            n = e(...n);
            let s = { name: t.name, args: n };
            this._operations.add(s);
            try {
              return await this._activate(), await t.apply(this, n);
            } finally {
              this._operations.delete(s),
        ...
        async readFile(t, e) {
          return this._backend.readFile(t, e);
        }
        async writeFile(t, e, i) {
          return await this._backend.writeFile(t, e, i), null;
        }
        async unlink(t, e) {
          return await this._backend.unlink(t, e), null;
        }
        async readdir(t, e) {
          return this._backend.readdir(t, e);
        }
        async mkdir(t, e) {
          return await this._backend.mkdir(t, e), null;
        }
        async rmdir(t, e) {
          return await this._backend.rmdir(t, e), null;
        }
        async rename(t, e) {
          return await this._backend.rename(t, e), null;
        }
        async stat(t, e) {
          const i = await this._backend.stat(t, e);
          return new s(i);
        }
        async lstat(t, e) {
          const i = await this._backend.lstat(t, e);
          return new s(i);
        }
        async readlink(t, e) {
          return this._backend.readlink(t, e);
        }
        async symlink(t, e) {
          return await this._backend.symlink(t, e), null;
        }
        async backFile(t, e) {
          return await this._backend.backFile(t, e), null;
        }
        async du(t) {
          return this._backend.du(t);
        }
        async flush() {
    ...
    function (t, e, i) {
      const { encode: n, decode: s } = i(7),
        r = i(10),
        o = i(11),
        { ENOENT: a, ENOTEMPTY: h, ETIMEDOUT: c } = i(1),
        l = i(12),
        u = i(13),
        d = i(14),
        _ = i(15),
      ...
      t.exports = class {
        ...
        async init(
          t,
          {
            ...
            fileDbName: s = t,
            db: r = null,
            fileStoreName: a = t + "_files",
            lockDbName: h = t + "_lock",
            lockStoreName: c = t + "_lock",
          } = {}
        ) {
          (this._name = t),
            (this._idb = r || new l(s, a)),
            (this._mutex = navigator.locks ? new _(t) : new d(h, c)),
            (this._cache = new o(t)),
            (this._opts = { wipe: e, url: i }),
            (this._needsWipe = !!e),
            i && ((this._http = new u(i)), (this._urlauto = !!n));
        }
        async activate() {
          ...
          if (!(await this._mutex.has())) throw new c();
        }
        async deactivate() {
        ...
        async readFile(t, e) {
          ...
          let n = null,
            r = null;
          try {
            (r = this._cache.stat(t)), (n = await this._idb.readFile(r.ino));
          } catch (t) {
          ...
          if (!n && this._http) {
            ...
            for (; "symlink" === e.type; )
              (t = p.resolve(p.dirname(t), e.target)),
                (e = this._cache.lstat(t));
            n = await this._http.readFile(t);
          }
          if (
            (n &&
              ((r && r.size == n.byteLength) ||
                ((r = await this._writeStat(t, n.byteLength, {
                  mode: r ? r.mode : 438,
                })),
                this.saveSuperblock()),
              "utf8" === i ? (n = s(n)) : (n.toString = () => s(n))),
            !r)
          )
            throw new a(t);
          return n;
        ...
        async writeFile(t, e, i) {
          const { mode: s, encoding: r = "utf8" } = i;
          if ("string" == typeof e) {
            if ("utf8" !== r)
              throw new Error('Only "utf8" encoding is supported in writeFile');
            e = n(e);
          }
          const o = await this._cache.writeStat(t, e.byteLength, { mode: s });
          await this._idb.writeFile(o.ino, e);
        }
        async unlink(t, e) {
        ...
        readdir(t, e) {
          return this._cache.readdir(t);
        }
        mkdir(t, e) {
          const { mode: i = 511 } = e;
          this._cache.mkdir(t, { mode: i });
        }
        rmdir(t, e) {
          if ("/" === t) throw new h();
          this._cache.rmdir(t);
        ...
        rename(t, e) {
          this._cache.rename(t, e);
        }
        stat(t, e) {
          return this._cache.stat(t);
        }
        lstat(t, e) {
          return this._cache.lstat(t);
        }
        readlink(t, e) {
          return this._cache.readlink(t);
        }
        symlink(t, e) {
          this._cache.symlink(t, e);
        }
        async backFile(t, e) {
          let i = await this._http.sizeFile(t);
          await this._writeStat(t, i, e);
        }
        du(t) {
          ...
          Object.defineProperty(e.prototype, "encoding", { value: "utf-8" }),
            (e.prototype.encode = function (t, e) {
              ...
              for (
                var i = t.length,
                  n = 0,
                  s = Math.max(32, i + (i >> 1) + 7),
                  r = new Uint8Array((s >> 3) << 3);
                e < i;
                ...
                if (
                  (n + 4 > r.length &&
                    ((s += 8),
                    (s = ((s *= 1 + (e / t.length) * 2) >> 3) << 3),
                    (a = new Uint8Array(s)).set(r),
                    (r = a)),
                  0 == (4294967168 & o))
                )
                  r[n++] = o;
                else {
                  if (0 == (4294965248 & o)) r[n++] = ((o >> 6) & 31) | 192;
            ...
            (i.prototype.decode = function (t, e) {
              ...
              e = 0;
              for (var i = (t = new Uint8Array(t)).length, n = []; e < i; ) {
                var s = t[e++];
                if (0 === s) break;
                if (0 == (128 & s)) n.push(s);
                else if (192 == (224 & s)) {
        ...
        return function () {
          ...
          return (
            ...
            (n = setTimeout(function () {
              if (((n = null), !o)) return t.apply(s, r);
            }, e)),
    ...
    function (t, e, i) {
      const n = i(0),
        { EEXIST: s, ENOENT: r, ENOTDIR: o, ENOTEMPTY: a } = i(1),
        h = 0;
      t.exports = class {
        constructor() {}
        _makeRoot(t = new Map()) {
        ...
        _countInodes(t) {
          let e = 1;
          for (let [i, n] of t) i !== h && (e += this._countInodes(n));
          return e;
        }
        autoinc() {
        ...
        _maxInode(t) {
          let e = t.get(h).ino;
          for (let [i, n] of t) i !== h && (e = Math.max(e, this._maxInode(n)));
          return e;
        }
        ...
        parse(t) {
          ...
          function i(t) {
            const i = ++e,
              n = 1 === t.length ? "dir" : "file";
            let [s, r, o] = t;
            return (
              (s = parseInt(s, 8)),
              (r = r ? parseInt(r) : 0),
              (o = o ? parseInt(o) : Date.now()),
              new Map([[h, { mode: s, type: n, size: r, mtimeMs: o, ino: i }]])
            );
          }
          let n = t.trim().split("\n"),
            s = this._makeRoot(),
          ...
          for (let t of n) {
            ...
            let [n, ...s] = t.split("\t"),
              o = i(s);
            if (e <= r[r.length - 1].indent)
              for (; e <= r[r.length - 1].indent; ) r.pop();
            r.push({ indent: e, node: o }), r[r.length - 2].node.set(n, o);
          }
          return s;
        }
        _lookup(t, e = !0) {
          ...
          for (let a = 0; a < o.length; ++a) {
            let c = o[a];
            if (!(i = i.get(c))) throw new r(t);
            if (e || a < o.length - 1) {
              const t = i.get(h);
              if ("symlink" === t.type) {
                let e = n.resolve(s, t.target);
                i = this._lookup(e);
              }
              s = s ? n.join(s, c) : c;
            }
        ...
        mkdir(t, { mode: e }) {
          if ("/" === t) throw new s();
          let i = this._lookup(n.dirname(t)),
            r = n.basename(t);
          if (i.has(r)) throw new s();
          let o = new Map(),
            a = {
              mode: e,
              type: "dir",
        ...
        writeStat(t, e, { mode: i }) {
          ...
          try {
            let e = this.stat(t);
            null == i && (i = e.mode), (s = e.ino);
          } catch (t) {}
          null == i && (i = 438), null == s && (s = this.autoinc());
          let r = this._lookup(n.dirname(t)),
            o = n.basename(t),
            a = { mode: i, type: "file", size: e, mtimeMs: Date.now(), ino: s },
            c = new Map();
          return c.set(h, a), r.set(o, c), a;
        }
        unlink(t) {
          let e = this._lookup(n.dirname(t)),
            i = n.basename(t);
          e.delete(i);
        }
        rename(t, e) {
          let i = n.basename(e),
            s = this._lookup(t);
          this._lookup(n.dirname(e)).set(i, s), this.unlink(t);
        }
        stat(t) {
        ...
        symlink(t, e) {
          ...
          try {
            let t = this.stat(e);
            null === s && (s = t.mode), (i = t.ino);
          } catch (t) {}
          null == s && (s = 40960), null == i && (i = this.autoinc());
          let r = this._lookup(n.dirname(e)),
            o = n.basename(e),
            a = {
              mode: s,
              type: "symlink",
        ...
        _du(t) {
          let e = 0;
          for (const [i, n] of t.entries()) e += i === h ? n.size : this._du(n);
          return e;
        }
        du(t) {
          let e = this._lookup(t);
    ...
    function (t, e, i) {
      ...
      t.exports = class {
        constructor(t, e) {
          (this._database = t),
            (this._storename = e),
            (this._store = new n.Store(this._database, this._storename));
        }
        saveSuperblock(t) {
    ...
    function (t, e, i) {
      const n = i(2),
        s = (t) => new Promise((e) => setTimeout(e, t));
      t.exports = class {
        constructor(t, e) {
            ...
            await n.update(
              ...
              (i) => {
                ...
                return (
                  ...
                  (this._lock = e ? { holder: this._id, expires: n } : i),
                  this._lock
                );
              },
              this._store
            ...
            (await n.update(
              ...
              (n) => {
                ...
                return (
                  (i = n && n.expires < r),
                  (e = void 0 === n || i),
                  (s = n && n.holder === this._id),
                  (this._lock = e ? { holder: this._id, expires: o } : n),
                  this._lock
                );
              },
              this._store
        ...
        async release({ force: t = !1 } = {}) {
          ...
          if (
            (await n.update(
              "lock",
              (n) => (
                (e = t || (n && n.holder === this._id)),
                (i = void 0 === n),
                (s = n && n.holder !== this._id),
                (this._lock = e ? void 0 : n),
                this._lock
              ),
              this._store
            ),
            await n.close(this._store),
            !e && !t)
          ) {
